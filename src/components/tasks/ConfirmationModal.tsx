        ...
        {isSuccess && (
          <div className="text-center mb-6">
            <div className="relative mx-auto w-32 h-24 mb-4">
              <Star
                className="absolute top-10 left-4 text-green-400 fill-current"
                size={16}
              />
              <Star
                className="absolute top-20 right-6 text-pink-400 fill-current"
                size={12}
              />
              <Star
                className="absolute bottom-2 left-8 text-blue-400 fill-current"
                size={14}
              />
              <Star
                className="absolute bottom-8 right-4 text-purple-400 fill-current"
                size={16}
              />
              <Star
                className="absolute top-24 right-2 text-orange-400 fill-current"
                size={10}
              />
              <h2
