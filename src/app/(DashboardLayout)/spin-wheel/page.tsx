...
const WHEEL_SEGMENTS = [
  { name: "Friends", color: "#86EFAC", textColor: "#065F46" },
  { name: "Sport", color: "#3B82F6", textColor: "#FFFFFF" },
  { name: "Family", color: "#A5B4FC", textColor: "#3730A3" },
  { name: "Nature", color: "#FB923C", textColor: "#FFFFFF" },
  { name: "Meditation", color: "#10B981", textColor: "#FFFFFF" },
  { name: "Art and Craft", color: "#F97316", textColor: "#FFFFFF" },
];
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{
                  ...
                  transition: "none",
                  border: "12px solid #DC2626", // Red border like Figma
                }}
              >
                {/* Wheel Segments */}
                ...
                {/* Center White Circle */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full shadow-lg z-20 border-4 border-red-600" />

                {/* White dots around the wheel - Exact Figma positioning */}
                {Array.from({ length: 16 }).map((_, index) => {
                  const angle = (360 / 16) * index;
                  const radian = (angle * Math.PI) / 180;
                  const radius = 170; // Closer to edge
                  return (
                    <div
                      key={index}
                      className="absolute w-4 h-4 bg-white rounded-full shadow-sm z-10"
                      style={{
          ...
          <div className="flex space-x-6 mb-8">
            <button
              ...
              className="px-12 py-4 bg-emerald-400 hover:bg-emerald-500 text-white rounded-xl font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-3 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
            ...
            <button
              ...
              className="px-12 py-4 bg-emerald-400 hover:bg-emerald-500 text-white rounded-xl font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              Go To Task
            </button>
          </div>
